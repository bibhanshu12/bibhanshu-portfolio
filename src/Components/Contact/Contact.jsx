...
export default function Contact() {
  const [formData, setFormData] = useState({
    ...
    email: "",
    phone: "",
    message: "", // Added message field for msgs
  });
...
Message: ${formData.message}
    ...
    // Create mailto link
    const mailtoLink = `mailto:mail.bibhanshu127@gmail.com?subject=Contact Form Submission from ${
      formData.name
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-8 bg-gray-100 rounded-xl shadow-lg">
              ...
              <div className="mt-8 flex gap-4">
                <a
                  href="https://github.com/bibhanshu12"
                ...
                <a
                  href="https://linkedin.com/in/bibhanshu-karn-118640253/"
                  className="text-gray-600 hover:text-gray-800"
                >
                  <svg
                    className="w-6 h-6"
                ...
                <a
                  href="https://www.instagram.com/bibhanshu12/"
                  className="text-gray-600 hover:text-gray-800"
                >
                <svg
                  className="w-6 h-6"
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M7.75 2h8.5A5.75 5.75 0 0 1 22 7.75v8.5A5.75 5.75 0 0 1 16.25 22h-8.5A5.75 5.75 0 0 1 2 16.25v-8.5A5.75 5.75 0 0 1 7.75 2zm0-2A7.75 7.75 0 0 0 0 7.75v8.5A7.75 7.75 0 0 0 7.75 24h8.5A7.75 7.75 0 0 0 24 16.25v-8.5A7.75 7.75 0 0 0 16.25 0h-8.5z" />
                  <path d="M12 7.75a4.25 4.25 0 1 0 0 8.5 4.25 4.25 0 0 0 0-8.5zm0 6.5a2.25 2.25 0 1 1 0-4.5 2.25 2.25 0 0 1 0 4.5zM17 6.5a1.125 1.125 0 1 0 0-2.25 1.125 1.125 0 0 0 0 2.25z" />
                </svg>
                </a>
              </div>
            </div>
